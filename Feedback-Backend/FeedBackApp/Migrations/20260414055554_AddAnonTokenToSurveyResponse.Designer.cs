...
namespace FeedBackApp.Migrations
{
    ...
    [Migration("20260414055554_AddAnonTokenToSurveyResponse")]
    partial class AddAnonTokenToSurveyResponse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FeedBackApp.Models.BankQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FeedBackApp.Models.BankQuestionOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FeedBackApp.Models.SurveyInvite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SurveyInvites");
                });

            modelBuilder.Entity("FeedBackApp.Models.SurveyOtp", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SurveyId", "Email", "IsUsed");

                    b.ToTable("SurveyOtps");
                });
            ...
            modelBuilder.Entity("FeedBackApp.Models.BankQuestionOption", b =>
                {
                    b.HasOne("FeedBackApp.Models.BankQuestion", "BankQuestion")
                        .WithMany("Options")
