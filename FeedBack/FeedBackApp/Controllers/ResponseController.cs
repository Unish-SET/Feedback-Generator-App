...
namespace FeedBackApp.Controllers
{
    ...
    public class ResponseController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetResponses(int surveyId, [FromQuery] PaginationParams pagination)
        {
            ...
            var result = await _responseService.GetResponsesAsync(surveyId, pagination, userId, role);
            return Ok(new { success = true, data = result });
        }
    }
}
